...
@Schema(description = "Dados de entrada para atualizacao parcial de um prestador de servico. "
        + "Apenas os campos enviados sao alterados.")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class ProviderPatchRequest {
